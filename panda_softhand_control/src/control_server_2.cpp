...
int main(int argc, char **argv)
{
    ...
    std::string hand_jt_topic_2 = "/left_hand/joint_trajectory_controller/follow_joint_trajectory/";
    ...
    HandPlan_2 hand_plan_obj_2(nh_, 20, "left_hand_synergy_joint");
    ...
    SlerpPlan_2 slerp_plan_obj_2(nh_, "panda_arm_2", "left_hand_ee_link", 20);

    ROS_INFO("Creating the pose plan object");
    PosePlan_2 pose_plan_obj_2(nh_, "panda_arm_2", "left_hand_ee_link");
